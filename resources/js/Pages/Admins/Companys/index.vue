    ...
    <admin-layout>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="text-gray-700 ml-1 md:ml-2 text-sm font-medium">
                                <Link :href="route('admin.companys.index')">
                                Companys
                                </Link>
                            </div>
                        </div>
        ...
        <div class="flex flex-row flex-wrap space-x-0 lg:space-x-2 mb-2 print:hidden">
            ...
            <jet-button class="w-full lg:w-auto text-center mb-2 lg:mb-0">
                <Link :href="route('admin.companys.create')">
                Create
                </Link>
            </jet-button>
        </div>
        ...
        <div v-for="(company, index) in companys.data" :key="index">
            <div class="bg-white">
                <div class="pt-2">
                    <!-- Product info -->
                    <div
                        class="max-w-2xl mx-auto pt-2 pb-2 px-4 sm:px-6 lg:max-w-7xl lg:pt-2 lg:pb-2 lg:px-2 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-2">
                        ...
                        <div class="mt-2 lg:mt-0 lg:row-span-3">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="ml-3 text-sm font-medium">
                                            {{ company.province }} - City : {{ company.city }} - Postal Code : {{
                                            company.postal_code }}
                                        </p>
                                    </div>
                            ...
                            <div class="mt-2 print:hidden">
                                <Link :href="route('admin.companys.edit', company.id)">
                                <button type="submit"
                        ...
                        <div
                            class="py-10 lg:pt-2 lg:pb-2 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
        ...
        <div class="bg-white px-3 py-1 flex items-center justify-between border-t border-gray-200 sm:px-3">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <pagination :current_page="current_page" :total="companys.total" :per_page="companys.per_page"
                    :last_page="companys.last_page" :from="companys.from" :to="companys.to" @paginate="paginate"
                    :offset="4">
                </pagination>
            </div>
